...
function act() {
    display("result0","If Loss, You will loss : " + formatNumber( input_cap() * (input_r() / 100).toFixed(2)));
    display("result1", "You can buy at the amount of Capitals : " + formatNumber( cal().toFixed(2)));
